{
	...
	DEBUT :
		...
		REPETER
			...
			SI (tas = 1) ET (allum_retir >= 1) ET (allum_retir <= 3) ET (allum_retir <= ligne1) ALORS                           
			...
			SI (tas = 2) ET (allum_retir >= 1) ET (allum_retir <= 3) ET (allum_retir <= ligne2) ALORS                                            //$ La condition est respectée ! Bravo Nico             
				ECRIRE "Vous avez retiré ", allum_retir, " allumettes dans le tas", tas.                   
			...
			SI (tas = 3) ET (allum_retir >= 1) ET (allum_retir <= 3) ET (allum_retir <= ligne3) ALORS                         
				ECRIRE "Vous avez retiré ", allum_retir, " allumettes dans le tas", tas.                   
				allum_rest <- allum_rest - allum_retir  
			...
			SI (tas = 4) ET (allum_retir >= 1) ET (allum_retir <= 3) ET (allum_retir <= ligne4) ALORS                           
				ECRIRE "Vous avez retiré ", allum_retir, " allumettes dans le tas", tas.                   
				allum_rest <- allum_rest - allum_retir  
			...
			SI (tas = 5) ET (allum_retir >= 1) ET (allum_retir <= 3) ET (allum_retir <= ligne5) ALORS                           
				ECRIRE "Vous avez retiré ", allum_retir, " allumettes dans le tas", tas.                   
				allum_rest <- allum_rest - allum_retir  
			...
			SI (tas = 6) ET (allum_retir >= 1) ET (allum_retir <= 3) ET (allum_retir <= ligne6) ALORS                           
				ECRIRE "Vous avez retiré ", allum_retir, " allumettes dans le tas", tas.                   
				allum_rest <- allum_rest - allum_retir  
			...
			SI ((tas < 1) ET (tas > 6)) ALORS                                                                                           //$ Si Nico aurait fait le malin et saisit un tas 7,
...
BEGIN 
	...
	//le programme demande un pseudo à chaque joueur (petite spécificité)
		...
		repeat
			...
			readln (allum_retir);                                                                                                                               
			if ((allum_retir >= 1) and (allum_retir <= 3)) then 
				begin                          
