...
//méthode pour initialiser le tableau et le jeton
{
    ...
    if (COTE == 7)
    {
        pointofJeton->x = 4;  // si jamais la grille est de 7x7
        pointofJeton->y = 3;
    }
...
int avancer_droite (Position *pointofJeton, int Carre[COTE][COTE])
{
...
int avancer_gauche(Position *pointofJeton, int Carre[COTE][COTE])
{
...
int rechercher_vide(Position pointofJeton, int Carre[COTE][COTE], int *pointofVide)
{
...
int avancer(Position *pointofJeton, int Carre[COTE][COTE])
{
...
int main()  //programme principal MAIN
{
    ...
    */
    ...
    {
        avancer_droite (&Jeton, Carre);
        avancer(&Jeton, Carre);
        rechercher_vide (Jeton, Carre, &vide);
        if (vide == 0)
        {
